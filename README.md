...
[![Release](https://img.shields.io/badge/release-v1.4.0-008aa3?style=flat-square)](https://github.com/jankln/KassenKnoten/releases/latest)
...
[![Tests](https://img.shields.io/badge/tests-381%20passing-1e8f6a?style=flat-square)](#contributing)
...
**Stable — 1.4.0.** Everything described above works and is in daily use. The data model,
...
`npm run check` — typecheck, lint, format and 381 tests — must pass, and nothing is
